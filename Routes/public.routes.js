...
public_routes.fees_collections= "/fees-collections";

public_routes.expenses= "/expenses";

public_routes.salary= "/salary";

public_routes.add_fees_collection= "/add-fees-collection";

public_routes.add_expenses= "/add-expenses";

public_routes.add_salary= "/add-salary";

public_routes.holiday= "/holiday";

public_routes.add_holiday= "/add-holiday";

public_routes.fees= "/fees";

public_routes.add_fees= "/add-fees";
...
public_routes.add_events= "/add-events";

public_routes.time_table= "/time-table";

public_routes.add_time_table= "/add-time-table";

public_routes.edit_time_table= "/edit-time-table";

public_routes.library = "/library";

public_routes.edit_books= "/edit-books";

public_routes.add_books= "/add-books";
...
public_routes.sports = "/sports";

public_routes.add_sports = "/add-sports";

public_routes.edit_sports = "/edit-sports";

public_routes.hostel = "/hostel";

public_routes.edit_room = "/edit-room";

public_routes.add_room = "/add-room";

public_routes.transport = "/transport";

public_routes.add_transport = "/add-transport";

public_routes.edit_transport = "/edit-transport";
...
public_routes.buttongroup = "/buttongroup";

public_routes.breadcrumbs = "/breadcrumbs";
...
public_routes.modal = "/modal";

public_routes.offcanvas = "/offcanvas";

public_routes.pagination = "/pagination";

public_routes.popover = "/popover";

public_routes.progress = "/progress";

public_routes.placeholders = "/placeholders";
